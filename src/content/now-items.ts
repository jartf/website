...
export const nowItems: NowItem[] = [
  ...
  },
  {
    ...
    content: {
      ...
      vi: "Cải thiện trang web này để ít phụ thuộc vào React hơn và quay lại sử dụng Astro",
      ru: "Улучшение этого веб-сайта для уменьшения зависимости от React и возврата к Astro",
      et: "Selle veebisaidi täiustamine, et vähendada sõltuvust Reactist ja naasta Astro juurde",
      da: "Forbedring af denne hjemmeside for at være mindre afhængig af React og vende tilbage til Astro",
      tr: "Bu web sitesini React'e daha az bağımlı hale getirmek ve Astro'ya geri dönmek için iyileştirmek",
      zh: "改进此网站以减少对 React 的依赖并回归 Astro",
      pl: "Ulepszanie tej strony internetowej, aby w mniejszym stopniu polegała na React i powrót do Astro",
      sv: "Förbättra denna webbplats för att förlita sig mindre på React och återgå till Astro",
      fi: "Tämän verkkosivuston parantaminen vähentämällä riippuvuutta Reactista ja palaamalla Astroon",
      tok: "mi pona e lipu ni: mi wile weka e ilo React, mi wile kepeken nasin Astro",
      vih: "改善張䇼尼抵𠃣附屬𠓨 React 欣吧𢮿吏使用 Astro",
    },
