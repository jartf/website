...
const BADGES = [
  ...
  { src: "/imagine.gif", alt: "An animated banner showing the text This site is powered by in one frame and imagination in the other frame." },
  ...
  { src: "/linux_powered.gif", alt: "An animated banner showing the text Linux powered next to the Tux logo" },
  ...
  { src: "/bitwarden.gif", alt: "A banner showing the Bitwarden logo, next to the word Bitwarden" },
  ...
  { src: "/porygon2.gif", alt: "A banner showing the text Porygon2! and a squeaking Porygon2" },
  { src: "/teto.gif", alt: "An animated banner showing Kasane Teto dancing left and right" },
  { src: "/tomandjerry.gif", alt: "An animated banner showing Tom and Jerry" },
  { src: "/milktea.gif", alt: "A banner showing a cup of bubble tea, next to the words Milk tea Now!" },
]
