    ...
    return [
      {
        ...
        headers: [
          ...
          },
          {
            ...
            value: [
              "default-src 'none'",
              "connect-src 'self' jarema.me ws.audioscrobbler.com api-gateway.umami.dev cusdis.com",
              ...
              "media-src 'self'",
              "object-src 'none'",
              "script-src 'self' 'unsafe-inline' cusdis.com",
              "style-src 'self' 'unsafe-inline' fonts.googleapis.com cusdis.com",
              "worker-src 'none'",
              "base-uri 'self'",
              "form-action 'self'",
