...
// API Configuration
export const LASTFM_API_URL = "https://ws.audioscrobbler.com/2.0/?method=user.getrecenttracks&user=jerryvu&api_key=c8526c48e3bd3c6f35e365480426f1be"

// PreMID API Configuration
export const PREMID_CONFIG = {
  AUTHORIZED_USER_ID: "490457129090547733",
  ACTIVITY_TIMEOUT_MS: 20 * 60 * 1000,
  CLEAR_THRESHOLD_MS: 2 * 60 * 1000,
  PRODUCTION_HOSTS: new Set(["jarema.me", "www.jarema.me"]),
  MAX_ACTIVITIES: 20,
  PRODUCTION_API_URL: "https://jarema.me/api/premid",
  API_TIMEOUT_MS: 5000,
}
